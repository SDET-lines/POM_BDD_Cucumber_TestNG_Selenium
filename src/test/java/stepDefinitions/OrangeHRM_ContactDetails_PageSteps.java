...
public class OrangeHRM_ContactDetails_PageSteps extends BasePage {
    ...
    public OrangeHRM_ContactDetails_PageSteps (OrangeHRM_HomePage homePage,
    ...
    public void user_verifies_address_is_displayed() {
